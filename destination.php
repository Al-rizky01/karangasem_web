...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="/dashboard"><img src="logo-karangasem-persegiPanjang.png" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="/dashboard"><img src="logo2-karangasem-persegi.png" alt="logo"/></a>
      </div>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <div class="card mb-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text"><?php echo implode(' ', array_slice(explode(' ', $row['description']), 0, 15)); ?>...</p>
                                    <p class="card-text"><small class="text-muted">Duration: <?php echo $row['duration']; ?> days</small></p>
                                    <p class="card-text">Price: Rp <?php echo number_format($row['price'], 0, ',', '.'); ?></p>
                                    <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
                                        <button type="button" class="btn btn-primary edit-btn" onclick="openEditModal(<?php echo $row['id']; ?>)">Edit</button>
                                    <?php else: ?>
                                        <a href="order-paket.php?id=<?php echo $row['id']; ?>" class="btn btn-success">Order</a>
                                    <?php endif; ?>
                                </div>
                            </div>
                    <?php

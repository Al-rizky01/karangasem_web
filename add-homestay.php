...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Jika semuanya berjalan lancar, coba untuk mengunggah file
            ...
            if (move_uploaded_file($_FILES["gambar"]["tmp_name"], $targetFile)) {
                ...
                $sql = "INSERT INTO homestay (name, owner_name, description, image_path) VALUES ('$nama', '$harga', '$deskripsi', '$targetFile')";
                // Eksekusi query
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
        <label for="nama">Nama Homestay:</label><br>
        <input type="text" id="nama" name="nama"><br>
        <label for="harga">Pemilik:</label><br>
        <input type="text" id="harga" name="harga"><br>
        <label for="deskripsi">Deskripsi Homestay:</label><br>

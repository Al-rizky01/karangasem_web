...
?>
        <?php if(isset($_SESSION['role']) && $_SESSION['role'] == 'admin'): ?>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addPackageModal">Add Homestay</button>
                    </div>
                </div>
            </div>
        <?php endif; ?>
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
            <a href="edit_homestay.php?id=<?php echo htmlspecialchars($row['id']); ?>" class="btn btn-primary">Edit</a>
        ...
        <?php else: ?>
            <a href="detail.php?package_id=<?php echo htmlspecialchars($row['id']); ?>" class="btn btn-primary">Order Now</a>
        <?php endif; ?>
    </div>
</div>
        ...
        echo "<p>No homestay available.</p>";
    }
    ?>
</div>
...
<div class="modal fade" id="addPackageModal" tabindex="-1" role="dialog" aria-labelledby="addPackageModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="process_add_homestay.php" method="post" enctype="multipart/form-data">
                <div class="modal-header">
                    <h5 class="modal-title" id="addPackageModalLabel">Add Homestay</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="packageName">Homestay Name</label>
